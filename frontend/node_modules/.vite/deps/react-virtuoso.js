...
var Lt = j(
  ([{ log: t }, { recalcInProgress: e }]) => {
    const n = U(), o = U(), r = ht(o, 0), s = U(), i = U(), l = v(0), c = v([]), d = v(void 0), m = v(void 0), x = v(void 0), p = v(void 0), T = v((u, g) => Ht(u, Fo[g])), w = v(void 0), R = v(0), h = bo(), f = ht(
      ...
      I(
        ...
        B(
          ([
            ...
            const Ft = (pt) => {
              S(), pt ? (O("retrying to scroll to", { location: H }, ft.DEBUG), _(T, H)) : (_(w, true), O("list did not change, scroll successful", {}, ft.DEBUG));
            };
            if (S(), q === "smooth") {
              let pt = false;
              a = Y(e, (Kt) => {
            ...
            if (N.length > 0) {
              ...
              for (const tt of Yt(ut, D, K)) {
                ...
                for (let ct = lt; ct <= St; ct++)
                  Ft.push({ data: q == null ? void 0 : q[ct], index: ct, offset: rt, size: X }), rt += X;
              }
            }
            if (!V)
            ...
            const Qt = C - 1, Et = ye([], (D) => {
              for (const K of Kt) {
                ...
                for (let ct = X; ct <= St && !(tt >= g); ct++)
                  D.push({ data: q == null ? void 0 : q[ct], index: ct, offset: tt, size: lt }), tt += lt + F;
              }
            ...
            if (Et.length > 0 && (te > 0 || b > 0)) {
              ...
              if (te > 0 && D.index > pt) {
                ...
                for (let lt = D.index - 1; lt >= D.index - rt; lt--) {
                  const ct = ((_a = Yt(ut, lt, lt)[0]) == null ? void 0 : _a.value) ?? D.size;
                  X -= ct + F, tt.unshift({ data: q == null ? void 0 : q[lt], index: lt, offset: X, size: ct });
                }
                Et.unshift(...tt);
              }
              if (b > 0 && K.index < Qt) {
                ...
                for (let X = K.index + 1; X <= K.index + rt; X++) {
                  const St = ((_b = Yt(ut, X, X)[0]) == null ? void 0 : _b.value) ?? K.size;
                  Et.push({ data: q == null ? void 0 : q[X], index: X, offset: tt, size: St }), tt += St + F;
                }
              }
            }
  ...
  ([
    ...
    return L(
      I(
        ...
        $(t),
        B(([[x, p, T, w, R, h, f, a], S]) => {
          const { calculateViewLocation: H = Do, done: y, ...k } = x, u = Nn(x, p, w - 1), g = ce(u, p.offsetTree, S) + R + h, C = g + Rt(p.sizeTree, u)[1], z = a + h, O = a + T - f, V = H({
            itemBottom: C,
            itemTop: g,
            locationParams: k,
            viewportBottom: O,
  ...
  ([
    ...
    return L(
      ...
      I(
        at(I(H, $t(1)), c),
        $(P(S), l, x, p),
        B(([[y, k], u, g, C, z]) => k && g && (u == null ? void 0 : u({ context: z, totalCount: y, scrollingInProgress: C }))),
        W((y) => !!y),
        zt(0)
      ),
      (y) => {
  ...
  ([
    ...
    return L(l, x), L(c, p), Y(
      ...
      ([T, w, R, h, f, a, S]) => {
        ...
        h && f !== null && a !== null && (R = f.scrollTop - a.offsetTop), R -= S, T({ ranges: H, scrollTop: R });
      }
    ), L(I(m, W(Ae), B(Yo)), r), L(
      I(
        s,
...
function Ye(t, e, n) {
  ...
  const x = import_react.default.forwardRef(function(a, S) {
    const { children: H, ...y } = a, [k] = import_react.default.useState(() => ye(So(t), (C) => {
      c(C, y);
    ...
    const g = n;
    return (0, import_jsx_runtime.jsx)(l.Provider, { value: k, children: n !== void 0 ? (0, import_jsx_runtime.jsx)(g, { ...tr([...o, ...r, ...i], y), children: H }) : H });
  }), p = (f) => {
    ...
    const S = import_react.default.useContext(l)[f], [H, y] = import_react.default.useState(an(it, S));
    return Ie(
      () => Y(S, (k) => {
        k !== H && y(un(k));
      }),
...
function eo(t, e, n, o = Xt, r, s) {
  ...
  function m(p) {
    ...
    let R, h, f;
    ke(T) ? (h = Math.max(
      Ht(T.document.documentElement, s === true ? "width" : "height"),
      s === true ? T.document.documentElement.scrollWidth : T.document.documentElement.scrollHeight
    ), R = s === true ? T.innerWidth : T.innerHeight, f = s === true ? window.scrollX : window.scrollY) : (h = T[s === true ? "scrollWidth" : "scrollHeight"], R = Ht(T, s === true ? "width" : "height"), f = T[s === true ? "scrollLeft" : "scrollTop"]);
    const a = h - R;
...
var Cn = import_react.default.memo(function({ showTopList: e = false }) {
  ...
  return !e && n.totalCount === 0 && H !== null && H !== void 0 ? (0, import_jsx_runtime.jsx)(H, { ...nt(H, m) }) : (0, import_jsx_runtime.jsx)(
    k,
    {
      ...nt(k, m),
...
var Rr = import_react.default.memo(function(e) {
  const n = M("useWindowScroll"), o = M("customScrollParent"), r = bt("fixedHeaderHeight"), s = bt("fixedFooterHeight"), i = M("fixedHeaderContent"), l = M("fixedFooterContent"), c = M("context"), d = kt(
    ...
    true,
    M("skipAnimationFrameInResizeObserver")
  ), x = o || n ? Er : Hr, p = o || n ? br : yr, T = M("TableComponent"), w = M("TableHeadComponent"), R = M("TableFooterComponent"), h = i ? (0, import_jsx_runtime.jsx)(
    w,
    {
      ref: d,
...
var Hr = Je({ useEmitter: en, useEmitterValue: M, usePublisher: bt });
var Er = Qe({ useEmitter: en, useEmitterValue: M, usePublisher: bt });
var Zr = so;
var Xr = so;
var bn = {
  bottom: 0,
...
var { ceil: Rn, floor: Ce, max: oe, min: Le, round: Hn } = Math;
function En(t, e, n) {
...
var Lr = j(
  ([
      ...
      I(
        ...
        B(
          ([
            ...
            const on = En(jt, Mt, lt), { bottom: rn, top: sn } = Bn(X, rt, tt, on), ln = Rn(b / ge), co = ln * he + (ln - 1) * ee - rn;
    ...
    L(Et, T.scrollSeekRangeChanged), L(
      I(
        O,
        $(C, z, k, F),
        B(([b, D, K, rt, tt]) => {
          ...
          let Pt = Ge(D, tt, K, Vt);
          return lt === "end" ? Pt = Hn(Pt - D.height + K.height) : lt === "center" && (Pt = Hn(Pt - D.height / 2 + K.height / 2)), ct !== void 0 && ct !== 0 && (Pt += ct), { behavior: St, top: Pt };
        })
      ),
      c
    );
